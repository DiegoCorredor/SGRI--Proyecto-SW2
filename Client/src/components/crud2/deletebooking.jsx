...
class delelement extends Component {
    ...
    render() {
        ...
        const header = <label className="text-3xl">Resultados de la busqueda</label>;
                    ...
                    <div className='align-items-center justify-content-center'>
                        <div className='py-2 px-5 sm:px-8 rounded'>
                            ...
                            <div className='card'>
                                ...
                                <div className='field grid align-items-end justify-content-end my-2 py-2'>
                                    <div className='col-1'>
                                        <Button label="Eliminar" icon="pi pi-delete-left" className="p-button-danger" />
                                    </div>
                                </div>
                            </div>
                        </div>
