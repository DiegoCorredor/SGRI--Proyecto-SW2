                ...
                <div className='py-4 px-4 lg:px-8 lg:mx-8'>
                    <div className='grid mt-8 pb-2 md:pb-8'>
                        ...
                        <div className='col-12 lg:col-6 my-auto flex flex-column lg:align-items-end text-center lg:text-left'>
                            ...
                            Historia:<br/>La Hacienda Marquesa de Pinares fue construida en el año 1.888 y es una de las más antiguas ubicada 
                    ...
                    <div className='grid mt-8 pb-2 md:pb-8'>
                        <div className='col-12 lg:col-6 my-auto flex flex-column lg:align-items-end text-center lg:text-right'>
                            <p className='text-700 text-2xl line-height-3 ml-0 md:ml-2'>
                            Misión:<br/>La misión del Hotel es ofrecer los servicios de alojamiento y descanso con el más alto nivel de comodidad, 
                            ...
                            <br/>Visión:<br/>HOTEL MARQUESA DE PINARES será reconocido para 2022 como uno de los Hoteles boutique más visitados de Tibasosa, 
                        ...
                        <div class="col-6">
                            <div class="grid justify-content-end">
                                <div class="col-6 md:col-3">
                                    <h4 class="text-2xl line-height-6 mb- text-900">Ubicanos</h4>
                                    <p class="line-height-3 text-xl block mb-2 text-700">Calle 4 #2-30 Este</p>
                                    <p class="line-height-3 text-xl block mb-2 text-700">Tibasosa</p>
                                    <p class="line-height-3 text-xl block mb-2 text-700">Boyacá, Colombia</p>
                                    <p class="line-height-3 text-xl block mb-2 text-700">(+57) 301 217 9561</p>
                                </div>
                                <div class="col-6 md:col-3">
                                    <h4 class="text-2xl line-height-3 mb-3 text-900">Siguenos</h4>
                                    <a class="line-height-3 text-xl block mb-2 text-700" href='https://www.facebook.com/hotelmarquesadepinares'><i className="pi pi-facebook"></i> Facebook</a>
                                    <a class="line-height-3 text-xl block mb-2 text-700" href='https://www.instagram.com/hotelmarquesadepinares/'><i className="pi pi-instagram"></i> Instagram</a>
                                </div>
                            </div>
                        </div>
                    </div>
